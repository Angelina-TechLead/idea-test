...
public class Practicum {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                System.out.println("Введите номер траты для удаления:");
                int transaction = scanner.nextInt(); // Прямое считывание целого числа
    ...
    public static void printMenu() {
        ...
        System.out.println("7 - Удалить конкретную трату");
